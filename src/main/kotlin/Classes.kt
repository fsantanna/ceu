...
sealed class Type(val tk: Tk, var wup: Any?, var wenv: Any?) {
    ...
    data class Tuple   (val tk_: Tk.Fix, val vec: List<Type>, val yids: List<Tk.ide>?): Type(tk_, null, null)
    data class Union   (val tk_: Tk.Fix, val common: Type.Tuple?, val vec: List<Type>, val yids: List<Tk.Ide>?): Type(tk_, null, null)
...
sealed class Expr (val n: Int, val tk: Tk, var wup: Any?, var wenv: Any?, var wtype: Type?) {
    ...
    data class TCons (val tk_: Tk.Fix, val arg: List<Expr>, val yids: List<Tk.ide>?): Expr(N++, tk_, null, null, null)
...
sealed class Stmt (val n: Int, val tk: Tk, var wup: Any?, var wenv: Any?) {
    ...
    data class Input  (val tk_: Tk.Fix, var xtype: Type?, val dst: Expr?, val lib: Tk.ide, val arg: Expr): Stmt(N++, tk_, null, null)
    data class Output (val tk_: Tk.Fix, val lib: Tk.ide, val arg: Expr): Stmt(N++, tk_, null, null)
