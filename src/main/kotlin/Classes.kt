...
sealed class Type(val tk: Tk, var wup: Any?, var wenv: Any?) {
    ...
    data class Tuple   (val tk_: Tk.Chr, val vec: List<Type>, val yids: List<Tk.Id>?): Type(tk_, null, null)
    data class Union   (val tk_: Tk.Chr, val vec: List<Type>, val yids: List<Tk.Id>?): Type(tk_, null, null)
